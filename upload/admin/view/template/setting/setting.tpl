          ...
          <table class="form">
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $logo; ?>" alt="" id="thumb-logo" />
                  ...
                  <br />
                  <a class="button" onclick="image_upload('logo', 'thumb-logo');"><?php echo $text_browse; ?></a>&nbsp; <a class="button" onclick="$('#thumb-logo').attr('src', '<?php echo $no_image; ?>'); $('#logo').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
              ...
              <td><div class="image"><img src="<?php echo $icon; ?>" alt="" id="thumb-icon" />
                  ...
                  <br />
                  <a class="button" onclick="image_upload('icon', 'thumb-icon');"><?php echo $text_browse; ?></a>&nbsp; <a class="button" onclick="$('#thumb-icon').attr('src', '<?php echo $no_image; ?>'); $('#icon').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_image_refine_search; ?></td>
              <td><input type="text" name="config_image_refine_search_width" value="<?php echo $config_image_refine_search_width; ?>" size="3" />
                x
                <input type="text" name="config_image_refine_search_height" value="<?php echo $config_image_refine_search_height; ?>" size="3" />
               </td>
            </tr>
            <tr>
