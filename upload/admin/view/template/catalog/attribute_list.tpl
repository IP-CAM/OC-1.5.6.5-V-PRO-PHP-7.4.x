        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'ad.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td style="text-align:left;"><?php if ($sort == 'attribute_group') { ?>
                ...
                <?php } ?></td>
              <td style="text-align:right;"><?php if ($sort == 'a.sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align:left;"><?php echo $attribute['attribute_group']; ?></td>
              <td style="text-align:right;"><?php echo $attribute['sort_order']; ?></td>
              <td style="text-align:right;"><?php foreach ($attribute['action'] as $action) { ?>
