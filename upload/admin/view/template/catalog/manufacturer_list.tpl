        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td style="text-align:center;"><?php if ($sort == 'sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($manufacturer['selected']) { ?>
                ...
                <?php } ?></td>
              <td style="text-align:left;"><?php echo $manufacturer['name']; ?></td>
              <td style="text-align:center;"><?php echo $manufacturer['sort_order']; ?></td>
              <td style="text-align:center;"><?php foreach ($manufacturer['action'] as $action) { ?>
