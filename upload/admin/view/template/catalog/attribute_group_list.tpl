        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'agd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td style="text-align:right;"><?php if ($sort == 'ag.sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($attribute_group['selected']) { ?>
                ...
                <?php } ?></td>
              <td style="text-align:left;"><?php echo $attribute_group['name']; ?></td>
              <td style="text-align:right;"><?php echo $attribute_group['sort_order']; ?></td>
              <td style="text-align:right;"><?php foreach ($attribute_group['action'] as $action) { ?>
