      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
			...
			<tr>
		 <td class="left"><?php echo $entry_display_type; ?>:</td>
			 <td colspan="3" class="left">
              <select name="display_type" id="input-display-type">
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              ...
              <td class="left"><div class="image"><img src="<?php echo $option_value['thumb']; ?>" alt="" id="thumb<?php echo $option_value_row; ?>" />
                  ...
                  <br />
                  <a class="button" onclick="image_upload('image<?php echo $option_value_row; ?>', 'thumb<?php echo $option_value_row; ?>');"><?php echo $text_browse; ?></a>&nbsp; <a class="button" onclick="$('#thumb<?php echo $option_value_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $option_value_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
...
$('select[name=\'type\']').bind('change', function() {
	if (this.value == 'select' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image') {
		$('#option-value').show();
		$('#input-display-type').closest(".form-group").show();
	} else {
		$('#option-value').hide();
		$('#input-display-type').closest(".form-group").hide();
	}
});
