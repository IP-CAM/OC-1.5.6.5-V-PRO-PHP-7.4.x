        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'od.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td style="text-align:right;"><?php if ($sort == 'o.sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($option['selected']) { ?>
                ...
                <?php } ?></td>
              <td style="text-align:left;"><?php echo $option['name']; ?></td>
              <td style="text-align:right;"><?php echo $option['sort_order']; ?></td>
              <td style="text-align:right;"><?php foreach ($option['action'] as $action) { ?>
