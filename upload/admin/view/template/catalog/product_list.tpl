        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td class="center"><a onclick="filter();" class="button"><?php echo $button_filter; ?></a></td>
            </tr>
            <?php if ($products) { ?>
            ...
            <tr>
             ...
             <td><?php echo $product['status']; ?></td>
			  ...
			  <a class="button" href="<?php echo HTTP_CATALOG ; ?>index.php?route=product/product&product_id=<?php echo $product['product_id']; ?>" target="_blank">Preview</a>								<?php foreach ($product['action'] as $action) { ?>
