        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'fgd.name') { ?>
                ...
                <?php } ?></td>
              <td style="text-align:right;"><?php if ($sort == 'fg.sort_order') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($filter['selected']) { ?>
                ...
                <?php } ?></td>
              <td style="text-align:left;"><?php echo $filter['name']; ?></td>
              <td style="text-align:right;"><?php echo $filter['sort_order']; ?></td>
              <td style="text-align:right;"><?php foreach ($filter['action'] as $action) { ?>
