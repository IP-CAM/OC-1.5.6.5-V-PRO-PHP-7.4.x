        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td style="text-align:left;"><?php if ($sort == 'dd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?></td>
              <td style="text-align:right;"><?php if ($sort == 'd.remaining') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($download['selected']) { ?>
                ...
                <?php } ?></td>
              <td style="text-align:left;"><?php echo $download['name']; ?></td>
              <td style="text-align:right;"><?php echo $download['remaining']; ?></td>
              <td style="text-align:right;"><?php foreach ($download['action'] as $action) { ?>
