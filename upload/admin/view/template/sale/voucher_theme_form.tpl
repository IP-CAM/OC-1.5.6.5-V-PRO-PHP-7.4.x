        ...
        <table class="form">
          ...
          <tr>
            ...
            <td valign="top"><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" />
                ...
                <br /><a class="button" onclick="image_upload('image', 'thumb');"><?php echo $text_browse; ?></a>&nbsp; <a class="button" onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '');"><?php echo $text_clear; ?></a></div>
              <?php if ($error_image) { ?>
