...
<div id="content">
  ...
  <div class="box">
          ...
          <table class="list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <a id="<?php echo str_replace('.', '-', $ip['ip']); ?>" class="button" onclick="removeBanIP('<?php echo $ip['ip']; ?>');"><?php echo $text_remove_ban_ip; ?></a>
                  <?php } else { ?>
                <a id="<?php echo str_replace('.', '-', $ip['ip']); ?>" class="button" onclick="addBanIP('<?php echo $ip['ip']; ?>');"><?php echo $text_add_ban_ip; ?></a>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
	...
	<div class="heading_2">
    <h1><img src="view/image/customer.png" alt="" /> <?php echo $heading_title; ?></h1>
   <div class="buttons right"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
 </div>
</div>
  </div>
</div>
