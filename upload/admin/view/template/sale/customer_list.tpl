      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'c.email') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php if ($sort == 'customer_group') { ?>
              ...
              <td class="center"><?php if ($sort == 'c.status') { ?>
                ...
                <?php } ?></td>
              <td class="center"><?php if ($sort == 'c.approved') { ?>
          ...
          <tbody>
            <tr class="filter">
              <td></td>
              <td align="left"><input type="text" name="filter_name" value="<?php echo $filter_name; ?>" /></td>
              <td align="left"><input type="text" name="filter_email" value="<?php echo $filter_email; ?>" /></td>
              <td align="center"><select name="filter_customer_group_id">
                  <option value="*"></option>
              ...
              <td align="center"><input type="text" name="filter_ip" value="<?php echo $filter_ip; ?>" /></td>
              <td align="center"><input type="text" name="filter_date_added" value="<?php echo $filter_date_added; ?>" size="12" id="date" /></td>
              <td></td>
            ...
            <tr>
              ...
              <td class="center"><select onchange="((this.value !== '') ? window.open('index.php?route=sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=' + this.value) : null); this.value = '';">
