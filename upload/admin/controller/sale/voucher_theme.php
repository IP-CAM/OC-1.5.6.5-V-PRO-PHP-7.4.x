...
class ControllerSaleVoucherTheme extends Controller { 
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $voucher_theme_id) {
			$voucher_theme_total = $this->model_sale_voucher->getTotalVouchersByVoucherThemeId($voucher_theme_id);

			if ($voucher_theme_total) {
				$this->error['warning'] = sprintf($this->language->get('error_voucher'), $voucher_theme_total);
			}  
		}
