...
// JTI MOD A dashboard Statistics chart shows the total customers but does not show the total orders
	// $query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id > '" . (int)$this->config->get('config_complete_status_id') . "' AND (DATE(date_added) = DATE(NOW()) AND HOUR(date_added) = '" . (int)$i . "') GROUP BY HOUR(date_added) ORDER BY date_added ASC");
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id >= '" . (int)$this->config->get('config_complete_status_id') . "' AND (DATE(date_added) = DATE(NOW()) AND HOUR(date_added) = '" . (int)$i . "') GROUP BY HOUR(date_added) ORDER BY date_added ASC");
// END JTI MOD dashboard Statistics chart shows the total customers but does not show the total orders
...
// JTI MOD B dashboard Statistics chart shows the total customers but does not show the total orders
...
// JTI MOD C dashboard Statistics chart shows the total customers but does not show the total orders
...
// JTI MOD D dashboard Statistics chart shows the total customers but does not show the total orders
