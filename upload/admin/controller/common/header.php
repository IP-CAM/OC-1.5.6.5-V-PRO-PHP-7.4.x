...
// JTI MOD Module: Scheduled Backup
$this->data['text_scheduled_backup'] = $this->language->get('text_scheduled_backup');
// END JTI MOD Module: Scheduled Backup
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['filemanager'] = $this->url->link('common/filemanager', 'token=' . $this->session->data['token'], 'SSL');
...
// JTI MOD Module: Scheduled Backup
			$this->data['scheduled_backup'] = $this->url->link('tool/scheduled_backup', 'token=' . $this->session->data['token'], 'SSL');
// END JTI MOD Module: Scheduled Backup
