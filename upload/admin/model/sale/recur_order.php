...
// $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "'");
	$query = $this->db->query("SELECT a.*, b.description FROM " . DB_PREFIX . "order_product a LEFT JOIN " . DB_PREFIX . "product_description b ON a.product_id = b.product_id WHERE order_id = '" . (int)$order_id . "'");
