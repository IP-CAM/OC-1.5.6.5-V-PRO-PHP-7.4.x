    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
			<td class="text-center" style="text-align:center;"><?php echo $column_image; ?></td>
          ...
          <tbody>
            ...
            <tr>
			<td class="text-center"><a href="<?php echo $product['href']; ?>"><img width="80" height="80" style="margin:1px;" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></td>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td colspan=1"  class="text-right"><?php echo $total['text']; ?></td>
            </tr>
            <?php } ?>
          </tfoot>
        </table>
      ...
      <div class="buttons clearfix">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn btn-primary"><?php echo $button_continue; ?></a></div><p>
      </div>
