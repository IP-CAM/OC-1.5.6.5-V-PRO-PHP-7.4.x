...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
   ...
   <div class="col-sm-12"> <label><b><?php echo $entry_captcha; ?></b></label></div>
                    <div class="col-sm-12">
    ...
    <br />   
          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div class="input-group date">
                <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" data-date-format="YYYY-MM-DD" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div class="input-group datetime">
                <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
                <span class="input-group-btn">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div class="input-group time">
                <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['option_value']; ?>" data-date-format="HH:mm" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
                <span class="input-group-btn">
                <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                </span></div>
            </div>
      ...
      <div class="row">
        ...
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $class = 'col-lg-4 col-md-4 col-sm-6 col-xs-6'; ?>
        <?php } else { ?>
        <?php $class = 'col-lg-3 col-md-4 col-sm-6 col-xs-6'; ?>
<!-- 	<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12"> -->
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition rounded">
            <div class="image"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
			<div class="caption"style="min-height:180px;margin:10px 0 0 0;">
