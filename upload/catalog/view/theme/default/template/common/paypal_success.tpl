...
<div class="container">
 ...
 <h1><?php echo $heading_title; ?></h1
  ...
  <?php } ?>
  <?php echo $text_message1; ?>
  <?php if (isset($button_paypal)) { ?>
  ...
  <form action="<?php echo $action; ?>" method="post">
	  ...
	  <div class="buttons">
		<div class="left">
 		  <input type="image" src="<?php echo $button_paypal; ?>" id="submit" name="submit" title="<?php echo $text_pay; ?>" alt="<?php echo $text_pay; ?>" />
		</div>
	  </div>
  </form>
  <?php } ?>
  <?php echo $text_message2; ?>
</div>
