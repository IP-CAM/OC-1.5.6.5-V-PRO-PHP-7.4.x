...
class ControllerAccountOrder extends Controller {
	...
	'return'   => $this->url->link('account/return/insert', 'order_id=' . $result['order_id'] . '&product_id=' . $result['order_id'], 'SSL')
	);
	}
	...
	$option_data[] = array(
	'name'  => $option['name'],
	'value' => (utf8_strlen($value) > 20 ? utf8_substr($value, 0, 30) . '..' : $value)
	);	
	}
	...
	'thumb'    => $thumb,
	'name'     => (utf8_strlen($product['name']) > 24 ? utf8_substr($product['name'], 0, 30) . '..' : $product['name']),
	'model'    => (utf8_strlen($product['model']) > 20 ? utf8_substr($product['model'], 0, 20) . '' : $product['model']),
	'option'   => $option_data,
