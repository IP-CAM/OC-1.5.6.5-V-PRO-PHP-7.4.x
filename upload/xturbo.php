 ...
 * NOTE:
 * This script should be run again following OpenCart upgrades
...
<div class="container">
	...
	<a href="xturbo.php?action=engine" class="btn btn-success btn-lg" onclick="return confirm('Are you sure you want to convert your Opencart database tables from MyISAM to InnoDB?');">Convert Database Engine</a><br><br>
	<a href="xturbo.php?action=indexes" class="btn btn-success btn-lg" onclick="return confirm('Are you sure you want to add Indexes to your Opencart database tables?');">Add Database Indexes</a><br><br>
	<a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF'].'?action=delete'); ?>" class="btn btn-danger btn-lg" onclick="return confirm('Are you sure you want to remove this script from your server?');">Remove This Script from Server</a>
	</div>
	</div>
...
function xturbo_delete_self() {
  unlink(__FILE__);
  if (file_exists('xturbo.php')) {
  }
  else {
  die("File removed successfully...");
  }
}
