  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
      <table class="form">
		...
		<td><input type="hidden" name="db_driver" value="mysqli"><strong>MySqli</strong> (hardcoded!)
            <br />
        ...
        <tr>
          <td><span class="required">*</span> DB User:</td>
    ...
    <p>2. Please enter your Admin Username and Password for the Shop-Administration.</p>
    <fieldset>
      <table class="form">
        <tr>
          <td><span class="required">*</span> Admin Username:</td>
        ...
        <tr>
          <td><span class="required">*</span> Admin Password:</td>
        ...
        <tr>
          <td><span class="required">*</span> Admin E-Mail:</td>
